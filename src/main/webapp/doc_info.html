                ...
                <div class="container-fluid">
                    <div class="row product">
                        ...
                        <div class="col-md-7 col-sm-4">
                            ...
                            <h4 name="experience">Стаж</h4>
                            <h4 name="city">Град </h4>
                            <button class="btn btn-default" type="button">Запази час</button>

                            <p>Специалист е по Педиатрия и Детска ендокринология и болести на обмяната с над 20 години опит. Научните интереси на д-р Средкова са в различни области на детската ендокринология - затлъстяване, захарен диабет, нарушения в пубертета, менструални нарушения, изоставане в растежа, заболявания </p>
